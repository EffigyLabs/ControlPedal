...
//Serial.println("log crv not yet implemented");
            ...
            case 2: { // audio ?  exponential ?
              // not yet supported 
#ifdef DEBUG
//Serial.println("audio crv not yet implemented");
#endif
              }
              break;
...
void handleMidiTraffic() {
  ...
  if (!((recpac.header >3) && (recpac.header < 8))) return;  // we've noticed that a midi sysex message is in progress
...
// redo this to fadeblink the LEDs according to the global fademax ******** tag
